...
function LogIn() {
  return (
    ...
    <div className='absolute left-64 top-16 text-black bg-white w-[calc(100%-256px)]'>
      <div className='flex items-center justify-between w-[950px] flex-col gap-y-5'>
        <svg role="img" xmlns="http://www.w3.org/2000/svg" height="65px" width="130px" version="1.1" viewBox="0 0 78 24" className='border-b-2 w-full p-3'>
          ...
          <button className='bg-[#405A93] text-white w-96 px-6 py-2 rounded-3xl font-bold tracking-wider'>Sign up with Facebook</button>
          ...
          <form className='flex flex-col w-[1000px] items-center gap-y-4'>
            
            <label htmlFor='e-mail' className='font-semibold'>Email address or username</label>
            <input type="e-mail" id="e-mail" name="e-mail" className='border-[1px] border-neutral-400 w-2/4 p-3' placeholder='Enter your meail' />
                  
            <label htmlFor='password' className='font-semibold'>Password</label>
            <input type="password" id="password" name="password" className='border-[1px] border-neutral-400 w-2/4 p-3' placeholder='Create a password' />

          </form>
          <button className='py-4 px-12 rounded-full bg-green-500 font-semibold'>Log in</button>
      </div>
    </div>
  )
}
