...
function SignUp() {
  return (
    ...
    <div className='absolute top-16 left-64 text-black bg-white w-[calc(100%-256px)]'>
      <div className='flex items-center justify-between w-[950px] flex-col gap-y-5'>
        <svg role="img" xmlns="http://www.w3.org/2000/svg" height="65px" width="130px" version="1.1" viewBox="0 0 78 24">
          ...
          <h1 className=' font-bold text-3xl'>Sign up for free to start listening.</h1>
          <button className='bg-[#405A93] text-white w-96 px-6 py-2 rounded-3xl font-bold tracking-wider hover:bg-[#344e85] active:border-2 active:border-black'>Sign up with Facebook</button>
          <button className='w-96 px-6 py-2 rounded-3xl border-2 border-black/60 font-bold tracking-wider text-neutral-600' >Sign up with Google</button>
          <div className='flex items-center gap-x-4'>
            <div className=' border-b-[1px] w-40 border-neutral-300 mt-1'></div>
            <div className='text-neutral-400'>or</div>
            <div className=' border-b-[1px] w-40 border-neutral-300 mt-1'></div>
          </div>
          <h3 className='font-bold text-lg'>Sign up with your email address</h3>

          <form className='flex flex-col w-full items-center gap-y-4'>
            
            <label htmlFor='name' className='font-semibold'>What's your email?</label>
            <input type="e-mail" id="fname" name="fname" className='border-[1px] border-neutral-400 w-2/4 p-3' placeholder='Enter your meail'  required/>
            
            <label htmlFor='name' className='font-semibold'>Confirm your email</label>
            <input type="e-mail" id="fname" name="fname" className='border-[1px] border-neutral-400 w-2/4 p-3' placeholder='Enter your meail again' required />
      
            <label htmlFor='name' className='font-semibold'>Create a password</label>
            <input type="password" id="fname" name="fname" className='border-[1px] border-neutral-400 w-2/4 p-3' placeholder='Create a password'  required/>

            <label htmlFor='name' className='font-semibold'>What should we call you?</label>
            <input type="text" id="fname" name="fname" className='border-[1px] border-neutral-400 w-2/4 p-3' placeholder='Enter a profile name' required/>
            ...
            <div className='flex gap-x-2 h-16'>
              ...
              <div>
                ...
                <input type='text' className='border-2 p-3 w-15' placeholder='DD' inputMode='numeric' maxLength='2' required/>
              </div>
              ...
              {/* Mont */}
                ...
                <div>
                  ...
                  <div>
                    ...
                    <select name="month" className='border-2 py-3 px-2' required>
                      <option value="" disabled className='invalid:text-neutral-400' >Month</option>
                ...
                <div>
                  ...
                  <input type='text' inputMode='numeric' className='border-2 p-3'placeholder='YYYY' maxLength="4" required/>
                </div>
            </div>
          </form>
          <button type='submit' className='py-4 px-12 rounded-full bg-green-500 font-semibold hover:bg-green-600 active:border-2 active:border-black'>Sign up</button>
          <span>Have an account? <Link to="/login" className='text-green-500 mb-10'>Log in</Link></span>
      </div>
    </div>
  )
}
