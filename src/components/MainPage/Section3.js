...
const loadMore = () => {
  ...
  return (
    <>
      <h2 className='text-white font-bold text-2xl mt-5'>Mood</h2>
      <Link to="mood" className='absolute right-11 text-neutral-400 font-bold tracking-widest text-xs hover:border-b-[1px] hover:text-neutral-400' onClick={() => loadMore()}>SEE ALL</Link>     
